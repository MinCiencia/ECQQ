...
WHERE 
	...
	w.word_1 IN 
		(SELECT tnw.word_1 from top_country_needs_role_pairs_individuals as tnw where tnw.macro = n.macro) AND
	w.word_2 IN (SELECT tnw.word_1 from top_country_needs_role_pairs_individuals as tnw where tnw.macro = n.macro)
